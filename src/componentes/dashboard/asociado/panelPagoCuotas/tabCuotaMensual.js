...
const TabPagoCuotaMensual = ({ router }) => {
  const { getCuotaMensual, pagoMensual } = useSaves()
  ...
  useEffect(() => {
    if (!cuotaMensual) {
      ...
      $("#cantidadPagarMensual").val(cuotaMensual)
    }
              ...
              <div className="flex flex-col sm:flex-row">
                <div className="relative flex-shrink-0 sm:w-7/12">
                  <input
                    onChange={handleChange}
                    type="text"
                    id="cantidadPagarMensual"
                    name="cantidadPagarMensual"
...
export default withRouter(TabPagoCuotaMensual)