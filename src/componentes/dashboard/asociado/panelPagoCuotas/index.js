...
const PanelPagoCuotas = ({ router }) => {
  const { getCuotaMensual, getCuotaManejo, pagoMensual, pagoManejo } = useSaves()
  ...
  const handleSubmitMensual = useCallback(data => {
    pagoMensual(cuotaMensual, setEstado)
  ...
  useEffect(() => {
    if (!cuotaMensual) {
      getCuotaMensual(setCuotaMensual)
    }
  }, [cuotaMensual, getCuotaMensual])
                    ...
                    ({ handleChange, handleSubmit, errors, touched }) => (
                      <div className="grid sm:px-10 lg:grid-cols-1 ">
                        ...
                        <button
                          ...
                          className="mt-4 mb-8 w- rounded-md bg-gradient-to-r from-sky-600 to-cyan-400 px-6 py-3 font-medium text-white"
                        >Pagar</button>
