                ...
                >
                  {
                    ({ handleChange, handleSubmit, errors, touched }) => (
                      <div className="grid sm:px-10 lg:grid-cols-1 ">
                        ...
                        <label htmlFor="cantidad_pagar" className="mt-4 mb-2 block text-sm font-medium">Código de seguridad</label>
                        <div className="relative">
                          <input type="text" id="cardholder" name="cardholder" className="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="Ingrese el código de seguridad de su tarjeta" />
                          <div className="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                        ...
                        <label htmlFor="cantidad_pagar" className="mt-4 mb-2 block text-sm font-medium">Cantidad a pagar</label>
                        <div className="flex flex-col sm:flex-row">
                          <div className="relative flex-shrink-0 sm:w-7/12">
                            <input type="text" id="cantidad_retiro" name="cantidad_retiro" className="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder=" " />
                            <div className="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
              ...
              >
                {
                  ({ handleChange, handleSubmit, errors, touched }) => (
                    <div className="grid sm:px-10 lg:grid-cols-1 ">
                      <br></br>
                      <p className="text-gray-700 sm:text-xl">En esta sección puede realizar el pago de la cuota de manejo de su cuenta.</p>
                      <p className="text-gray-400">La cuota de manejo puede ser pagada en el transcurso del año, esta nos ayuda a cubrir gastos administrativos, para brindarle la mejor experiencia a nuestros asociados.
                        Recuerde que si terminado el año no ha cancelado el monto total del pago, se descontará de su ahorro individual.</p>
                      <p className="text-gray-400">Complete el pago llenando la información de su método de pago.</p>
                      ...
                      <label htmlFor="cardNo" className="mt-4 mb-2 block text-sm font-medium">Fecha de expiración</label>
                      <input
                        id="fechaDeExpiración"
                        name="fechaDeExpiración"
                        type="date"
