...
import Solicitud_retiro_exitoso from "../modales/solicitud_retiro_exitosa"
...
export default function Solicitud_retiro() {
  ...
  }, [cargarDatosSolicitud, setDatos, datos])
          ...
          <div className="grid sm:px-10 lg:grid-cols-1 ">
            <div className="mt-10 bg-white px-4 pt-8 lg:mt-0">
              ...
              <button
                ...
                className="mt-4 mb-8 w-full rounded-md bg-gradient-to-r from-sky-600 to-cyan-400 px-6 py-3 font-medium text-white">Solicitar retiro</button>
            </div>
