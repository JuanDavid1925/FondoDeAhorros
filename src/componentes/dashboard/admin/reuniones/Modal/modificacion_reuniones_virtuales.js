...
export default function Modificacion_reuniones_virtuales({ children, onClose }) {
                                    ...
                                    <div>
                                        <div className="px-8 ml-10 mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%]">
                                            <form className="justify-left grid grid-cols-1 gap-2 mt-8 md:grid-cols-2">
                                                ...
                                                <div>
                                                    <label className="block font-medium mb-2 text-sm text-gray-600 dark:text-gray-700">Enlace </label>
                                                    <input
                                                        id="enlace"
                                                        name="enlace"
                                                        type="text"
