                    ...
                    <div className="mx-auto w-full max-w-lg">
                        ...
                        <form className="mt-10">
                            ...
                            <div className="grid gap-6 sm:grid-cols-2">
                                ...
                                <div className="relative z-0">
                                    <input type="text" name="email" className="peer block w-full appearance-none border-0 border-b border-gray-500 bg-transparent py-2.5 px-0 text-sm text-gray-900 focus:border-indigo-600 focus:outline-none focus:ring-0" placeholder=" " required defaultValue={""} />
                                    <label className="absolute top-3 -z-10 origin-[0] -translate-y-6 scale-75 transform text-sm text-gray-500 duration-300 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-focus:left-0 peer-focus:-translate-y-6 peer-focus:scale-75 peer-focus:text-indigo-600 peer-focus:dark:text-indigo-500">Cantidad a retirar</label>
                                </div>
                                <div className="relative z-0">
