...
export default function Footer() {
        ...
        <footer className="text-center lg:text-left bg-gray-100 text-gray-600">
            ...
            <div className="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
                ...
                <div className="flex justify-center">
                    <a href="https://es-la.facebook.com/" className="mr-6 text-gray-600">
                    ...
                    <a href="https://twitter.com/?lang=es" className="mr-6 text-gray-600">
                    ...
                    <a href="https://co.linkedin.com/" className="mr-6 text-gray-600">
    ...
    ">
                            ...
                            Fondo de ahorros y préstamos
                        </h6>
                        <p>
                            Aquí encontrarás nuestra información de contacto para que mantengas actualizado y te enteres de cualquier novedad.
                        </p>
                    </div>
                    ...
                    <div className>
                        ...
                        <p className="flex items-center justify-center md:justify-start mb-4">
                            ...
                            Carrera 65 # 11 - 83, Cali - Colombia
                        </p>
                        <p className="flex items-center justify-center md:justify-start mb-4">
            ...
            <div className="text-center p-6 bg-gray-200">
                ...
                <a className="text-gray-600 font-semibold" href="https://tailwind-elements.com/">Los cuatro y media.</a>
            </div>
        </footer>
