...
export default function Modificacion_cliente({ children, onClose, documento, nombre, apellido, telefono }) {
                                                            ...
                                                            <div>
                                                                ...
                                                                <div className="mt-5 flex items-start mb-6">
                                                                    <div className="flex items-center h-5">
                                                                        <input id="checkbox" aria-describedby="remember" type="checkbox" className="bg-gray-50 border-gray-300 focus:ring-3 focus:ring-blue-300 h-4 w-4 rounded" required />
                                                                    </div>
