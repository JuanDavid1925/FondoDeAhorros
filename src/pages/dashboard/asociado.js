      ...
      <aside className="ml-[-100%] fixed z-10 top-0 pb-3 px-6 w-full flex flex-col justify-between h-screen border-r bg-white transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]">
        <div>
          ...
          <ul className="space-y-2 tracking-wide mt-8">
            ...
            <li>
              <a href="#" onClick={() => setEstadoPagina(2)} className={"px-4 py-3 flex items-center space-x-4 rounded-xl text-gray-600 group " + ((mostrar_pagina === 2) ? "bg-gradient-to-r from-sky-600 to-cyan-400" : "")}>
            ...
            <li>
              <a href="#" onClick={() => setShowModal(true)} className={"px-4 py-3 flex items-center space-x-4 rounded-xl text-gray-600 group " + ((mostrar_pagina === 3 || mostrar_pagina === 4) ? "bg-gradient-to-r from-sky-600 to-cyan-400" : "")}>
            ...
            <li>
              <a href="#" onClick={() => setEstadoPagina(5)} className={"px-4 py-3 flex items-center space-x-4 rounded-xl text-gray-600 group " + ((mostrar_pagina === 5) ? "bg-gradient-to-r from-sky-600 to-cyan-400" : "")}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
            ...
            <li>
              <a href="#" onClick={() => setEstadoPagina(6)} className={"px-4 py-3 flex items-center space-x-4 rounded-xl text-gray-600 group " + ((mostrar_pagina === 6) ? "bg-gradient-to-r from-sky-600 to-cyan-400" : "")}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
            ...
            <li>
              <a href="#" onClick={() => setEstadoPagina(7)} className={"px-4 py-3 flex items-center space-x-4 rounded-xl text-gray-600 group " + ((mostrar_pagina === 7) ? "bg-gradient-to-r from-sky-600 to-cyan-400" : "")}>
