        ...
        <section className="bg-white">
            <div className="container flex flex-col items-center px-4 py-20 mx-auto xl:flex-row">
                <div className="flex justify-center xl:w-1/2">
                    <img className="h-80 w-80 sm:w-[28rem] sm:h-[28rem] flex-shrink-0 object-cover rounded-full" src="./prestamos2.jpg" alt="" />
                </div>
                <div className="flex flex-col items-center mt-6 xl:items-start xl:w-1/2 xl:mt-0">
                    <h2 className="text-3xl font-bold tracking-tight text-gray-800 xl:text-4xl dark:text-gray-900">
                        Préstamos para nuestros clientes
                    </h2>
                    <p className="block max-w-2xl mt-4 text-xl text-gray-500 dark:text-gray-500">
                        Regístrate e inicia sesión para solicitar un préstamo, debes solicitarlo a tráves de nuestra plataforma ingresando en el apartado de
                        Préstamos, ahí deberás ingresar el monto que necesitas y el asociado al que deseas realizar la solicitud, el asociado revisará tu solicitud
                        y te dará una respuesta en los siguientes días hábiles.
                    </p>
