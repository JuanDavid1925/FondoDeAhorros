  ...
  return (
    <div className="static overflow-hidden bg-white">
              ...
              <nav className="relative flex items-center justify-between sm:h-10 lg:justify-start" aria-label="Global">
                <div className="flex flex-shrink-0 flex-grow items-center lg:flex-grow-0">
                  <div className="flex w-full items-center justify-between md:w-auto">
                    <a href="#">
                      <span className="sr-only">FAP</span>
                      <img
                        alt="FAP"
          ...
          <main className="mx-auto mt-10 max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
                <span className="block xl:inline">Fondo de ahorros y</span>{' '}
                <span className="block text-indigo-600 xl:inline"> préstamos</span>
              </h1>
              <p className="mt-3 text-base text-gray-500 sm:mx-auto sm:mt-5 sm:max-w-xl sm:text-lg md:mt-5 md:text-xl lg:mx-0">
                Somos una entidad que día a día trabaja por sus asociados y su familia pensando siempre en elevar su nivel económico, social, educativo y cultural, mediante la promoción de una cultura empresarial solidaria que procura el fomento del ahorro, la satisfacción de necesidades y el bienestar social.
      ...
      <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
        <img
          className="overflow-hidden h-56 w-full object-cover sm:h-72 md:h-96 lg:h-full lg:w-full"
          src="./inicio.webp?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2850&q=80"
          alt=""
        />
      </div>
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
            ...
            <div>
              <div className="mt-10">
                ...
                >
                  <div className="absolute transform sm:left-1/2 sm:top-0 sm:translate-x-8 lg:left-1/2 lg:top-1/2 lg:-translate-y-1/2 lg:translate-x-8">
                    <div className="flex items-center space-x-30 lg:space-x-20">
                      <div className="grid flex-shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">
                      </div>
                      <div className="grid flex-shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">
                        <div className="h-64 w-100 overflow-hidden rounded-lg">
                          <img
                            src="./clientes1.jpg"
                            alt=""
                            className="h-full w-full object-cover object-center"
                ...
                >
                  <div className="absolute transform sm:left-1/2 sm:top-0 sm:translate-x-8 lg:left-1/2 lg:top-1/2 lg:-translate-y-1/2 lg:translate-x-8">
                    <div className="flex items-center space-x-0 lg:space-x-0">
                      ...
                      <div className="grid flex-shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">
                        <div className="h-66 w-100 overflow-hidden rounded-lg">
                          <img
                            src="./ahorro2.png"
                            alt=""
                            className="h-full w-full object-cover object-center"
      ...
      <footer class="text-center text-white">
        ...
        <div class="text-center text-gray-700 p-4">
          © 2022 Copyright:
          <a class="text-gray-800" href="https://tailwind-elements.com/"> Los cuatro y media.</a>
        </div>
      </footer>
    </div>
